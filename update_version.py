...
def main():
  ...
  plistpath = scriptpath + "/resources/MultibandDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultibandDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultibandDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultibandDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultibandDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultibandDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MultibandDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MultibandDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MultibandDistortion.iss",inplace=1):
